    ...
    <div class="bg-page purchase-view">
      <div class="form-panel">
        <div class="content-wrapper">
          <h5 class="company-info-title">Company Info</h5>
          <form method="" action="">
            <div class="form-row">
            ...
            <h5 class="company-info-title mt-4">Factory contacts *</h5>
            ...
            <div class="row form-top-spacing">
              <div class="form-group col-md-12">
                <input
                  type="text"
                  class="form-control"
                  placeholder="Enter factory contact "
                  name="Enter factory contact "
                  value=""
                />
              </div>
            </div>
            
            <h5 class="company-info-title mt-3">Factory contacts *</h5>
            ...
            <div class="row form-top-spacing">
              <div class="form-group col-md-12">
                <textarea
                  ...
                  class="form-control"
                  rows="5"
                  placeholder="List all your goods"
                  name="List all your goods"
                ></textarea>
              </div>
            </div>
            <h5 class="company-info-title mt-4">Please provide the packing list or upload a file</h5>
